            ...
            success: function(response){
                ...
                if(response.data[0].comentarios){
                    ...
                    if(response.data[0].comentarios[i].id_estado == 5){
                        buttonH2.innerHTML = 'Detalle Ingreso Orden Reparación ' + '<p style="color:black; display:inline; font-size:0.8rem">' + fecha + '<p>';
                    }

                    if(response.data[0].comentarios[i].id_estado == 8){
                        buttonH2.innerHTML = 'Detalle Reparación Finalizada ' + '<p style="color:black; display:inline; font-size:0.8rem">' + fecha + '<p>';
                    }
