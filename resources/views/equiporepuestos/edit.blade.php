...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar Equipo Repuesto</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {!! Form::model($equipo, ['method' => 'PATCH', 'route'=>['equiporepuestos.update', $equipo->id]]) !!}
                        <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group"> 
                                        <label for="descripcion">Detalles del Equipo Repuesto</label>
                                        <div class="form-control" style="visibility: hidden; padding:0; height:20px">
                                        </div>
                                        {!! Form::textarea('descripcion', $descripcion, ['style' => 'width:100%; resize:none;'])!!}                                        
                                    </div>
                                </div>
