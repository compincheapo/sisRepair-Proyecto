                ...
                <div class="card">
                  ...
                  <div class="collapse" id="mycard-collapse">
                    ...
                    <div class="form-group col-md-6"> 
                            ...
                            <input type="text" name="precio" value="{{$precioData}}" class="form-control">
                    </div>
                       ...
                       <div class="form-group col-md-12">
                            ...
                            <a href="{{ url('/pagodiagnostico') }}" class="btn btn-info">Limpiar</a>
                        </div>
                    </div>
                    </form>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive table-bordered">
                            <table class="table table-striped">
                                    ...
                                    @foreach($pagos as $pago)
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a class="btn btn-primary mr-2" href="{{route('comprobanteDiagnostico', $pago->id)}}">Comprobante</a>
                                                <a class="btn btn-warning mr-2" href="{{route('reciboDiagnostico', $pago->id)}}">Recibo</a>
                                ...
                                {!! $pagos->appends(['usuario' => $usuarioData, 'modelo' => $modeloData, 'marca' => $marcaData, 'tipopago' => $tipopagoData, 'tipoequipo' => '$tipoequipoData', 'orden' => $ordenData, 'precio' => $precioData, 'fechapagodesde' =>  $fechapagodesdeData, 'fechapagohasta' => $fechapagohastaData])->links() !!}
                        </div>
                        </div>
