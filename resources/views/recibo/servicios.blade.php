	...
	<div id="header">
        <table style="width:100%" >
                        ...
                        <tr>
                            ...
                            <strong style="font-size: 14pt;">Recibo de Pago Orden de Servicio - {{$servicio}} </strong><br>
                            <strong style="font-size: 8pt;">Nro de Recibo: {{$recibo->id}} </strong><br>
                        ...
                        <tr>
                            ...
                            <span>El presente recibo ha sido emitido de acuerdo con los servicios prestados
                                por SIC Servicios Informáticos y recepción de la cantidad total de efectivo de los mismos.</span><br>
                            </td>
        ...
        <div class="inner_fixed" style="border-top:0px;font-size: 10pt; height: 80px;">
            <strong>Firma y aclaración:</strong><br><br>
            <span>............................................</span><br>
        </div>
    </div>
